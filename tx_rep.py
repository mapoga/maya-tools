...
class RenamingDialog(QtWidgets.QDialog):
    ...
    def create_layout(self):
        ...
        self.replace_button = QtWidgets.QPushButton('Replace Selected')
        ...
        self.stats_tx = QtWidgets.QLabel('missing tx: 0')
        self.stats_file = QtWidgets.QLabel('missing files: 0')
        ...
        execute_replace_layout = QtWidgets.QVBoxLayout()
        ...
        main_input_layout = QtWidgets.QHBoxLayout()
        ...
        self.replace_button.setSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.refresh_button.setSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
...
class tx_table_view(QtWidgets.QTableView):
    def __init__(self, parent=None, *args):
        QtWidgets.QTableView.__init__(self, parent, *args)
